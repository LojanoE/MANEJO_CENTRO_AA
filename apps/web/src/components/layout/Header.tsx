      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="hidden md:flex items-center gap-1.5 rounded-lg px-2.5 py-2 text-sm font-medium text-slate-700 hover:bg-slate-100 hover:text-slate-900 transition"
          ...
          >
            ...
            <span>{collapsed ? 'Mostrar nombres' : 'Ocultar nombres'}</span>
            <svg
